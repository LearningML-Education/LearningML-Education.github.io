...
[LearningML Basic - v1.2](https://basic.learningml.org/editor) [LearningML Advanced - v1.3](https://advanced.learningml.org/editor) [lml\_snap!](https://snap.learningml.org) [LearningML-Desktop](https://localhost:8080/learningml-desktop/)

**Ideal para introducirse en el mundo del Machine Learning.** Se puede usar desde los últimos cursos de primaria.

En esta versión **se añade la clasificación de conjuntos de números y el [modo avanzado](https://localhost:8080/el-modo-avanzado-de-learningml/)**, con el que podrás explorar el comportamiento de los algoritmos de ML.
...
http://localhost:8080/wp-content/uploads/2020/05/mini-tutorial-intro-imagenes.mp4
