---
title: "LearningML as an Open Source Project"
date: 2022-05-10
categories: 
...
#### Can someone install LearningML on a server other than [https://learningml.org](https://learningml.org)?
...
**In the _README.md_ and _CONTRIBUTING.md_ files of each project you will find information on how to create a development environment and how to contribute to the project.** Possible ways to contribute as a developer are:
...
Of course, **if you have done an activity that uses LearningML** in some way and you want to tell about it on this website, you can contact me through the [contact form](https://web.learningml.org/en/contact/). Without a doubt, these activities **are the most valuable resources you can contribute to the project as a teacher and are more than welcome.**
...
If you are looking for a tool for teaching artificial intelligence and computer programming, and want to know more about what LearningML can offer you, or you just have an idea for your research and need help, you can use the [contact form](https://web.learningml.org/en/contact/) to tell me about it.

* * *

**And, of course, whether you are a developer, teacher, researcher or whatever; if you have any ideas to contribute to the project, let me know 😉 ([contact form](https://web.learningml.org/en/contact/) or via twitter @juandalibaba).**
